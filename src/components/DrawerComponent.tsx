...
export function DrawerComponent({ triggerText }: DrawerComponentProps) {
        ...
        >
          <DrawerHeader className="text-center">
            ...
            <DrawerDescription className="text-gray-400 mt-2">
              Sign up to receive notifications for our launch! The first 50
              users will enjoy 3 months free.
            </DrawerDescription>
          </DrawerHeader>
